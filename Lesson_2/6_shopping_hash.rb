...
puts "-" * 85
puts format("Товар: #{name} | Цена за единицу: #{details[:price]} | Количество: #{details[:quantity]} | Итоговая сумма: #{item_total}",
            name, details[:price], details[:quantity], item_total)
puts "-" * 85
